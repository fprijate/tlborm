...
There is also the [Macros chapter of the Rust Book](https://doc.rust-lang.org/book/ch19-06-macros.html) which is a more approachable, high-level explanation, and the [practical introduction](https://danielkeep.github.io/practical-intro-to-macros.html) chapter of this book, which is a guided implementation of a single macro.
